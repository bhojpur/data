...
func (c *debugClient) Profile(ctx context.Context, in *ProfileRequest, opts ...grpc.CallOption) (Debug_ProfileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Debug_ServiceDesc.Streams[0], "/v1.debug.Debug/Profile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *debugClient) Binary(ctx context.Context, in *BinaryRequest, opts ...grpc.CallOption) (Debug_BinaryClient, error) {
	stream, err := c.cc.NewStream(ctx, &Debug_ServiceDesc.Streams[1], "/v1.debug.Debug/Binary", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *debugClient) Dump(ctx context.Context, in *DumpRequest, opts ...grpc.CallOption) (Debug_DumpClient, error) {
	stream, err := c.cc.NewStream(ctx, &Debug_ServiceDesc.Streams[2], "/v1.debug.Debug/Dump", opts...)
	if err != nil {
		return nil, err
	}
...
var Debug_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/api/v1/debug/debug.proto",
}
