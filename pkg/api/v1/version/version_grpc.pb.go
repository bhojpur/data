...
func (c *aPIClient) GetVersion(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Version, error) {
	out := new(Version)
	err := c.cc.Invoke(ctx, "/v1.version.API/GetVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.version.API/GetVersion",
	}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/api/v1/version/version.proto",
}
